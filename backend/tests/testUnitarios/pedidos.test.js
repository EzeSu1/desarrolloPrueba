...
describe('Pedido', () => {
    ...
    beforeEach(() => {
        ...
        direccion1 = new DireccionEntrega("Calle Falsa 123", 1232, 2, "E", 1188, "Ciudad", "Provincia", "País");
        direccion2 = new DireccionEntrega("Calle Falsa 123", 2, 3,'A', 1188, "Ciudad", "Provincia", "País");
